...
st.subheader(f'{selected_city} Today:')
...
if tab == 'Weather':
    ...
    with a1:
        ...
        st.markdown(f"<div style='padding: 5% 2% 2% 5%; margin-bottom: 20px; background-color: #263c52;'><h3 style='text-align: center;'>{temperature}°C</h3></div>", unsafe_allow_html=True)
    ...
    with a2:
        ...
        st.markdown(f"<div style='padding: 5% 2% 2% 5%; margin-bottom: 20px; background-color: #263c52;'><h3 style='text-align: center;'>{humidity}%</h3></div>", unsafe_allow_html=True)
    ...
    with a3:
        ...
        st.markdown(f"<div style='padding: 5% 2% 2% 5%; margin-bottom: 20px; background-color: #263c52;'><h3 style='text-align: center;'>{condition}</h4></div>", unsafe_allow_html=True)
...
if tab == 'Air Quality':
    ...
    with c3:
        ...
        st.markdown(f"<div style='padding: 5% 2% 2% 5%; margin-bottom: 14px; background-color: #263c52;'><h3 style='text-align: center;'>{Ozone}</h3></div>", unsafe_allow_html=True)
