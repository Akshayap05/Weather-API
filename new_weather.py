...
if tab == 'Weather':
    ...
    with a1:
        st.markdown("<div style='padding: 10% 3% 3% 1%;  background-color: #0074cc;'><h6 style='text-align: center;'>Temperature</h6></div>", unsafe_allow_html=True)
        st.markdown(f"<div style='padding: 10% 3% 3% 1; margin-bottom: 20px; background-color: #0074cc;'><h3 style='text-align: center;'>{temperature}°C</h3></div>", unsafe_allow_html=True)

    with a2:
        st.markdown("<div style='padding: 10% 3% 3% 1%; background-color: #0074cc;'><h6 style='text-align: center;'>Humidity</h6></div>", unsafe_allow_html=True)
        st.markdown(f"<div style='padding: 10% 3% 3% 1; margin-bottom: 20px; background-color: #0074cc;'><h3 style='text-align: center;'>{humidity}%</h3></div>", unsafe_allow_html=True)

    with a3:
        st.markdown("<div style='padding: 10% 3% 3% 1%; background-color: #0074cc;'><h6 style='text-align: center;'>Condition</h6></div>", unsafe_allow_html=True)
        st.markdown(f"<div style='padding: 10% 3% 3% 1%; margin-bottom: 20px; background-color: #0074cc;'><h3 style='text-align: center;'>{condition}</h4></div>", unsafe_allow_html=True)
    #    icon_url = "https:" + icon
