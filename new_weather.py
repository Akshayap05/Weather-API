...
if tab == 'Weather':
    ...
    with a2:
        st.markdown("<div style='padding: 10% 3% 3% 3%; background-color: #0074cc;'><h5 style='text-align: center;'>Humidity</h5>", unsafe_allow_html=True)
    ...
    with a3:
        ...
        st.markdown(f"<div style='padding: 10% 3% 3% 10%; background-color: #0074cc;'><h3 style='text-align: center;'>{condition}</h4>", unsafe_allow_html=True)
    #    icon_url = "https:" + icon
