...
if tab == 'Weather':
    ...
    with a1:
        ...
        st.markdown(f"<div style='padding: 10% 3% 3% 3%; margin-bottom: 10px; background-color: #0074cc;'><h3 style='text-align: center;'>{temperature}°C</h3></div>", unsafe_allow_html=True)
