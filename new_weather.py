...
if tab == 'Weather':
    ...
    with a1:
        ...
        st.markdown(f"<div style='padding: 5% 2% 2% 5%; margin-bottom: 50px; background-color: #263c52;'><h3 style='text-align: center;'>{temperature}°C</h3></div>", unsafe_allow_html=True)
